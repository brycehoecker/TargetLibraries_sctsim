...
def main():
    ...
    fname_res ='/home/cta/UserSpace/Justus/test_100ns.results'
    fname_r0 = '/home/cta/UserSpace/Justus/test_100ns_r0.tio'
    fname_r0_2 = '/home/cta/UserSpace/Justus/test_ped_r0.tio'
    #print(fname_ped)
    ...
    if acq:
      ...
      if os.path.exists(fname_r0_2):
         ...
         tm = setup_tm(my_ip, tm_ip, delay=300)
      #take_data(my_ip=my_ip, tm=tm, fname=fname_r0_2, hvon=False, sleep=30)
      take_data(my_ip=my_ip, tm=tm_ip, fname=fname_r0, hvon=True, sleep=5)
