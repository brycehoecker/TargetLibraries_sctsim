...
Trigger = 1   # Ext=1 Soft=0 Int=2
TrackDataTakingTime = 1 # if set to 1 it will track data taking time and gives an output in the end
HVMode = 1 # 0: not using HV; 1: old way to set low side; 2: new way to set low side
numBlock = 2
moduleID = 111
...
sleeptime = 5  #sleep time after each run (without PC)
sleepBeforeRun = 30 # sleep time before data taking
