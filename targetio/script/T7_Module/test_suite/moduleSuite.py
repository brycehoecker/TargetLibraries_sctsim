...
deadTimeList=[50000] #formerly [500, 5000, 15000]
freq = 100
if(threshScan):
...
deadtime4readout = deadTimeList[0]
...
#This works to get a low noise rate from fee 112 with fpm 4.8
consThresh=[1050,1050,1050,1050, 900,1050,1000,950, 850,1050,900,900, 540,640,640,520]
...
if(internalTrigger):
	...
	for j in range(12,16):
		...
		outRunList, outFileList = LEDPulseWFs.LEDPulseWaveforms(tester,module,frequency,trigger,runDuration, numBlock=numBlock, triggerDly=684, groupList=[j], thresh=consThresh, outputDir=testDir)
		...
		plot_waves.plot_events(outRunList, testDir, dataset, group=j, numBlock=numBlock)
...
if(externalTrigger):
	...
	runDuration = 20
	#outRunList, outFileList = LEDPulseWFs.LEDPulseWaveforms(tester,module,frequency,trigger,runDuration, numBlock=numBlock, triggerDly=684, groupList=[j], thresh=consThresh, outputDir=testDir)
	outRunList, outFileList = LEDPulseWFs.LEDPulseWaveforms(tester,module,frequency,trigger,runDuration, numBlock=numBlock, triggerDly=700, outputDir=testDir)
	...
	runListFile = refreshFile(runListFile, assocRun)
	fileListFile = refreshFile(fileListFile, assocFile)
	print "The output directory is:", testDir
	plot_waves.plot_events(outRunList, testDir, dataset, group='EXT', numBlock=numBlock)
