...
ourModuleIDList=[119] ###[118,125,126,119,108,121,110,128,123,124,112,100,111,114,107] #123,124] ##[124, 123, 112, 100, 111, 114, 107]  #[119, 108, 116, 128, 123, 124, 112, 111, 114, 107] 
...
triggerModule=119
runDuration=1800 #50 #in seconds
numberOfRuns =24  #27
HV=1   #(1=ON, 0=OFF)
changeHV=True
numBlock=2
...
#		buf.Clear()
		...
		outRunList, outFileList, nEvents, nPacketsWritten, nTriggers = LEDPulseWFs_miles.LEDPulseWaveforms(moduleList, \
#								listener, \
#								buf, \
								pi, \
                ...
                if changeHV:
                    HV=(HV+1)%2
                    for q in range(len(moduleList)):
                        tuneModule.getTunedWrite(ourModuleIDList[q],moduleList[q],VpedList[q], pi, HV=HV, numBlock=numBlock, addBias=addBias, wbias=wbias)
