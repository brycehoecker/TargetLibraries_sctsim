...
baseIP=["192.168.10.", "192.168.12.", "192.168.13."]
...
std_my_ip=["192.168.10.1", "192.168.12.1", "192.168.13.1"]
...
#Set these parameters:listener.GetEventBuffer
triggerModule=123
