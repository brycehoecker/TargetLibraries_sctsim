...
public:
  ...
  void GetTimeStamp(uint32_t event_id) {
      CTA::TargetDriver::EventHeader tempHeader;
      fReader->GetEventHeader(event_id, tempHeader);
      fHeader.GetTimeStamp(fCPU_s, fCPU_ns);
  }
  ...
  void GetBlock(uint32_t event_index);
