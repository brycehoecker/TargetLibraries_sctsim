...
ourModuleIDList=[ 118, 125, 126, \
		  119, 108, 121, 110, \
		  123, 128, 124, 112, \
		  100, 111, 114, 107 ]  #[119, 108, 116, 128, 123, 124, 112, 111, 114, 107] 
#ourModuleIDList=[123]
#		  100, 114]  #[119, 108, 116, 128, 123, 124, 112, 111, 114, 107] 
...
changeThresh=0
kBufferDepth = 100000
channelsPerPacket = 64 #FIXME 8 #16 is good for 1 module/4 blocks, 1 is good for 1 module/10 blocks
...
if triggerModule in ourModuleIDList:
	print "Trigger module in module list at index", ourModuleIDList.index(triggerModule)
...
#	if k>3:           #FIXME
#		module.WriteSetting("DataSendingDelay", 0x927)
#	elif k>7:           #FIXME
#		module.WriteSetting("DataSendingDelay", 0x11F8)
...
#								buf, \
	...
	#	delay=delay+100    ###648
		...
		print "******** Return rates are: Events:", nEvents, "expected packets:", rateList[4], "received packets:", rateList[5], "Dropped packets:", rateList[6], "*************************Fraction of total:", rateList[6]/float(rateList[4])
		if(rateList[5]>0):
