...
#			moduleList[trigModule].WriteSetting("TriggerEff_Duration", 0xFFFFFF)
			...
			#	moduleList[trigModule].WriteASICSetting("Thresh_{}".format(refGROUP), asic, 0, True)
			   ...
			   if(asic==999):
				...
				modList = [123,124,114,111,100,128,119,108,121]
				asic1=0 
				asic2=0
	
				for asic0 in range(0,1):
				  for gr0 in range(0,1):
				     for mod1 in range(0,1):
				      for asic1 in range(0,1):
					for gr1 in range(1,2):
			...
			if(calTrigEn):
				...
				time.sleep(1)	
                        ...
                        if log_temp:
                            ...
                            temp_sleep_schedule(module,runDuration,runID, HV)
	                else:
